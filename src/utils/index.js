...
/**
 * Init Page element animate
 */
export function InitAnimate() {
  const animateBoxes = document.getElementsByClassName('animate-box')
  for (let i = 0; i < animateBoxes.length; i++) {
    addClass(animateBoxes[i], 'animated')
    addClass(animateBoxes[i], animateBoxes[i].getAttribute('data-animate-effect'))
  }
}
